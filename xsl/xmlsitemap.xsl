  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/xsl/jquery.tablesorter.min.js"></script>
        <script type="text/javascript" src="/xsl/xmlsitemap.xsl.js"></script>
        <link href="/xsl/xmlsitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
